...
### Changed
- **Workspace version bump**: `0.2.0 → 0.3.0` (additive backward-compatible — pre-release `[Unreleased]`). Canonical declaration in `Cargo.toml::[workspace.package].version`, mirrored on `fd-dag` (override) and `nextjs/package.json`.
