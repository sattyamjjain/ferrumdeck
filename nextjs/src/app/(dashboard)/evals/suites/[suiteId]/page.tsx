...
export default function SuiteDetailPage({ params }: SuiteDetailPageProps) {
    ...
    // The eval suite BFF route returns 501 until a gateway eval backend exists
    // (#7). Say so honestly instead of "Suite not found", which would blame the
    // suite for a backend that was never built.
    if (suiteError instanceof APIError && suiteError.isNotImplemented) {
        return (
            <div className="flex flex-col h-full">
                ...
                <div className="flex-1 min-h-0 px-6 pb-6">
                    <NotImplementedState
                        ...
                        description="This eval suite can't be shown because the dashboard has no gateway eval backend yet. A blank 'suite not found' page would blame the suite — this is 'not built yet'. Tracked in issue #7."
            ...
            <div className="flex-shrink-0 px-6 pt-6 pb-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Button
                        ...
                        disabled={runEvalSuiteMutation.isPending}
                    >
