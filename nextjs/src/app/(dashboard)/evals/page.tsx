...
export default function EvalsPage() {
    ...
    // The eval BFF routes return 501 until a gateway eval backend exists (#7).
    // Show one honest "not implemented" notice instead of three empty tabs that
    // would read as "no suites / no runs / no regressions" — a clean bill of
    // health for a feature that was never wired.
    const evalsNotImplemented = [suitesError, runsError, regressionError].some(
        (e) => e instanceof APIError && e.isNotImplemented,
    );
            ...
            <div className="flex-1 min-h-0 px-6 pb-6">
                {evalsNotImplemented ? (
                    <NotImplementedState
                        ...
                        description="The dashboard has no gateway eval backend yet, so suites, runs, and regression reports can't be shown. An empty view here would read as 'no data' — this is 'not built yet', not a clean bill of health. Tracked in issue #7."
                        ...
                        <TabsContent value="regression" className="mt-6">
                            {regressionLoading ? (
                                ...
                                <div className="space-y-6">
                                    ...
                                    {regressionData.regressions_by_suite
                                        .length > 0 ? (
                                        <div className="space-y-4">
