...
| --- | --- | --- | --- | --- | --- |
| `asb` | 2026-09-20 | pass | 1.00 | 7 | block 100%, benign utility 100% |
| `coherence_fp` | 2026-09-20 | pass | 0.90 | 4 | false-positive rate 10.20% (25/245), Wilson 95% CI [7.01%, 14.63%]; 5 trace(s) from a real agent run |
| `governed-benchmark` | 2026-09-20 | pass | 1.00 | 7 | governed blocked 100% vs ungoverned 0% |
| `injection_defense` | 2026-09-20 | pass | 1.00 | 7 | block 100%, benign utility 100% |
| `regression` | 2026-09-20 | pass | 1.00 | 7 | 20/20 tasks passed, avg score 1.00, assertion coverage 100% |
| `smoke` | 2026-09-24 | pass | 1.00 | 42 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |

## Recent measurements

The last 20 of 75 rows from [`eval-health-series.jsonl`](eval-health-series.jsonl), newest first. The table above says what is true today; this says what was true before, which is the part a snapshot throws away. **A number that has never moved here has not been re-measured** — check `measured` against `recorded` before reading a steady value as a stable one.

| Measured | Recorded | Suite | Result | Score | Harness | Detail |
| --- | --- | --- | --- | --- | --- | --- |
| 2026-09-24 | 2026-09-24 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-23 | 2026-09-23 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-22 | 2026-09-22 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-21 | 2026-09-21 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-20 | 2026-09-20 | `regression` | pass | 1.00 | 0.8.19 | 20/20 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-20 | 2026-09-20 | `injection_defense` | pass | 1.00 | 0.8.19 | block 100%, benign utility 100% |
| 2026-09-20 | 2026-09-20 | `governed-benchmark` | pass | 1.00 | 0.8.19 | governed blocked 100% vs ungoverned 0% |
| 2026-09-20 | 2026-09-20 | `coherence_fp` | pass | 0.90 | 0.8.19 | false-positive rate 10.20% (25/245), Wilson 95% CI [7.01%, 14.63%]; 5 trace(s) from a real agent run |
| 2026-09-20 | 2026-09-20 | `asb` | pass | 1.00 | 0.8.19 | block 100%, benign utility 100% |
...
| 2026-09-16 | 2026-09-16 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-15 | 2026-09-15 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-14 | 2026-09-14 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-13 | 2026-09-13 | `regression` | pass | 1.00 | 0.8.19 | 20/20 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-13 | 2026-09-13 | `injection_defense` | pass | 1.00 | 0.8.19 | block 100%, benign utility 100% |
| 2026-09-13 | 2026-09-13 | `governed-benchmark` | pass | 1.00 | 0.8.19 | governed blocked 100% vs ungoverned 0% |
| 2026-09-13 | 2026-09-13 | `coherence_fp` | pass | 0.90 | 0.8.19 | false-positive rate 10.20% (25/245), Wilson 95% CI [7.01%, 14.63%]; 5 trace(s) from a real agent run |
...
_Generated 2026-09-24 07:19 UTC._
