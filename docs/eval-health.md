...
| --- | --- | --- | --- | --- | --- |
| `asb` | 2026-09-13 | pass | 1.00 | 6 | block 100%, benign utility 100% |
| `coherence_fp` | 2026-09-13 | pass | 0.90 | 3 | false-positive rate 10.20% (25/245), Wilson 95% CI [7.01%, 14.63%]; 5 trace(s) from a real agent run |
...
| `smoke` | 2026-09-16 | pass | 1.00 | 34 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |

## Recent measurements

The last 20 of 62 rows from [`eval-health-series.jsonl`](eval-health-series.jsonl), newest first. The table above says what is true today; this says what was true before, which is the part a snapshot throws away. **A number that has never moved here has not been re-measured** — check `measured` against `recorded` before reading a steady value as a stable one.
...
| 2026-09-10 | 2026-09-10 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
| 2026-09-09 | 2026-09-09 | `smoke` | pass | 1.00 | 0.8.19 | 3/3 tasks passed, avg score 1.00, assertion coverage 100% |
...
| 2026-09-06 | 2026-09-06 | `injection_defense` | pass | 1.00 | 0.8.18 | block 100%, benign utility 100% |
| 2026-09-06 | 2026-09-06 | `governed-benchmark` | pass | 1.00 | 0.8.18 | governed blocked 100% vs ungoverned 0% |
| 2026-09-06 | 2026-09-06 | `coherence_fp` | pass | 0.90 | 0.8.18 | false-positive rate 10.42% (25/240), Wilson 95% CI [7.16%, 14.92%]; 0 trace(s) from a real agent run |
...
_Generated 2026-09-16 07:21 UTC._
